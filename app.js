...
function renderPodium() {
  ...
  podiumEl.innerHTML = `<div class="podium-row">${arranged.map((p, idx) => `
    <div class="podium-col ${classes[idx]}">
      <div class="avatar">${classes[idx] === 'first' && globalLeaderboard.indexOf(p) < 5 ? '<span class="crown">👑</span>' : ''}${escapeHtml((p.display_name || 'u')[0].toUpperCase())}</div>
      <div class="bar"></div>
